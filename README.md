...
## Data Science / ML Engineer (Python/PostgreSQL)

🎓 **Студент НИУ ВШЭ** (Информационная безопасность, 2025-2029)  
📍 Москва 

---

### 💡 Изучаю:
- Feature Engineering и интерпретируемость ML-моделей
- Продвинутый SQL (оконные функции, оптимизация запросов)
- FinTech: скоринг, риск-моделирование, фрод-детекшн
